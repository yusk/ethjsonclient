...
class EthJsonRpc(object):
    ...
    def __init__(self, host='localhost', port=GETH_DEFAULT_RPC_PORT,
                 tls=False):
        self.host = host
        self.port = port
        self.tls = tls
    ...
    def transfer(self, from_, to, amount):
        ...
        return self.eth_sendTransaction(
            from_address=from_, to_address=to, value=amount)
    ...
    def call(self, address, sig, args, result_types):
        ...
        data = response[2:].encode()
        # return decode_abi(result_types, data)
        return data

    def call_with_transaction(self,
                              from_,
                              address,
                              sig,
                              args,
    ...
    def eth_getTransactionCount(self, address, block=BLOCK_TAG_LATEST):
        ...
        block = validate_block(block)
        return hex_to_dec(
            self._call('eth_getTransactionCount', [address, block]))
    ...
    def eth_getBlockTransactionCountByHash(self, block_hash):
        ...
        '''
        return hex_to_dec(
            self._call('eth_getBlockTransactionCountByHash', [block_hash]))
    ...
    def eth_getBlockTransactionCountByNumber(self, block=BLOCK_TAG_LATEST):
        ...
        block = validate_block(block)
        return hex_to_dec(
            self._call('eth_getBlockTransactionCountByNumber', [block]))
    ...
    def eth_getUncleCountByBlockHash(self, block_hash):
        ...
        '''
        return hex_to_dec(
            self._call('eth_getUncleCountByBlockHash', [block_hash]))
    ...
    def eth_getUncleCountByBlockNumber(self, block=BLOCK_TAG_LATEST):
        ...
        block = validate_block(block)
        return hex_to_dec(
            self._call('eth_getUncleCountByBlockNumber', [block]))
    ...
    def eth_getTransactionByBlockHashAndIndex(self, block_hash, index=0):
        ...
        TESTED
        '''
        return self._call('eth_getTransactionByBlockHashAndIndex',
    ...
    def eth_getUncleByBlockHashAndIndex(self, block_hash, index=0):
        ...
        TESTED
        '''
        return self._call('eth_getUncleByBlockHashAndIndex',
                          [block_hash, hex(index)])
    ...
    def eth_getUncleByBlockNumberAndIndex(self,
        ...
        '''
        block = validate_block(block)
        return self._call('eth_getUncleByBlockNumberAndIndex',
                          [block, hex(index)])
    ...
    def eth_newFilter(self,
                      from_block=BLOCK_TAG_LATEST,
                      to_block=BLOCK_TAG_LATEST,
                      address=None,
                      topics=None):
        '''
